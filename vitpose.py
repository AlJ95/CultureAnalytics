...
pose_estimiation_model = onepose.create_model().to("cuda")
...
for year in range(2022, 1980, -1):
    ...
    for i, img_path in enumerate(sub_paths):
        ...
        for i, cls, box, prob in zip(range(len(clses)), clses, boxes, probs):
            ...
            onepose.visualize_keypoints(draw_img, keypoints, pose_estimiation_model.keypoint_info,
                                        pose_estimiation_model.skeleton_info)
